...
from .old.compiler import KS03OldCompiler
from .new.compiler import KS03NewCompiler
...
def gatt_from_prefix(prefix: DeviceNamePrefix) -> GattProfile:
    ...
    return gatt_profile_by_prefix.get(prefix, GattProfile.new("", "", "", ""))

def transmitter_from_prefix(prefix: DeviceNamePrefix, client: BleakClient) -> Transmitter:
...
class DeviceProfile:
    ...
    compiler: Callable[[], StateCompiler]
